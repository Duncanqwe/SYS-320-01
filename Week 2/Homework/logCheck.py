...
def _logs(filename, host, term):

    # querey the yaml file for the 'term' or direction and retireve the strings to search on
    # terns = keywords['apache']['php']
    terms = keywords[host][term]
